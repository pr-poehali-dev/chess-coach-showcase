  ...
  const services = [
    {
      ...
      description: 'Персональная программа под ваш уровень и цели. Разбор партий, изучение дебютов и эндшпилей.',
      price: 'от 3 000 ₽',
      duration: '60 мин',
      popular: false,
      features: ['Анализ текущего уровня', 'Индивидуальный план', 'Разбор ваших партий', 'Онлайн или офлайн'],
    ...
    },
    {
      icon: 'Crown',
      emoji: '♛',
      title: 'Интенсив для профи',
      description: 'Глубокое погружение в стратегию и тактику для игроков, стремящихся к результату на турнирах.',
      price: 'от 7 000 ₽',
      duration: '120 мин',
      popular: true,
      features: ['Подготовка к турнирам', 'Дебютный репертуар', 'Психология игры', 'Разбор топ-партий'],
    ...
    },
    {
      ...
      description: 'Весёлые и эффективные занятия для детей и взрослых в мини-группах до 6 человек.',
      price: 'от 1 200 ₽',
      duration: '90 мин',
      popular: false,
      features: ['До 6 человек', 'Все возрасты', 'Игровой формат', 'Соревнования внутри группы'],
